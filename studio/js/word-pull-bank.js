/**
 * Top 100 lists from American English frequency PDF
 * Categories: verbs, adjectives, nouns, adverbs & prepositions
 */
window.BurnfolderWordPullBank = {
  verbs: [
  ...
  adjectives: [
    ...
    "real", "best", "right", "social", "only", "public", "sure", "low", "early", "able",
    "human", "local", "late", "hard", "major", "better", "economic", "strong", "possible", "whole",
    "free", "military", "true", "federal", "international", "full", "special", "easy", "clear", "recent",
    "certain", "personal", "open", "red", "difficult", "available", "likely", "short", "single", "medical",
  ...
  adverbsAndPrepositions: [
    "up", "so", "out", "just", "now", "how", "then", "more", "also", "here",
    "well", "only", "very", "even", "back", "there", "down", "still", "in", "as",
    "to", "when", "never", "really", "most", "on", "why", "about", "over", "again",
    "where", "right", "off", "always", "today", "all", "far", "long", "away", "yet",
    "often", "ever", "however", "almost", "later", "much", "once", "least", "ago", "together",
    "around", "already", "enough", "both", "maybe", "actually", "probably", "home", "of course", "perhaps",
    "little", "else", "sometimes", "finally", "less", "better", "early", "especially", "either", "quite",
    "simply", "nearly", "soon", "certainly", "quickly", "not", "recently", "before", "usually", "thus",
...
window.BurnfolderWordPullAll = [].concat(
  window.BurnfolderWordPullBank.verbs,
  window.BurnfolderWordPullBank.adjectives,
  window.BurnfolderWordPullBank.nouns,
  window.BurnfolderWordPullBank.adverbsAndPrepositions
);
